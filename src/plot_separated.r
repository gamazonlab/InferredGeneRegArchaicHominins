...
tissue_list<-dir('c:/Users/dan/Desktop/neanderthals/results/')

for (tissue_i in 1:length(tissue_list)){
  #tissue_i=44
  print(tissue_i)
  
  df<-read.table(paste0('c:/Users/dan/Desktop/neanderthals/results/',tissue_list[tissue_i]),header = T,stringsAsFactors = F)
  ...
  par(mfcol=c(1,1))
  png(paste0('c:/Users/dan/Desktop/neanderthals/plots/r2/',tissue_list[tissue_i],'_legend.png'),width = 800,height = 800,res=150)
  ...
  png(paste0('c:/Users/dan/Desktop/neanderthals/plots/r2/',tissue_list[tissue_i],'_remove_Neand_Samples.png'),width = 800,height = 800,res=150)
  ...
  #---
  png(paste0('c:/Users/dan/Desktop/neanderthals/plots/r2/',tissue_list[tissue_i],'_remove_Neand_SNPs.png'),width = 800,height = 800,res=150)
  ...
  #---
  png(paste0('c:/Users/dan/Desktop/neanderthals/plots/r2/',tissue_list[tissue_i],'_remove_Neand_Samples & SNPs.png'),width = 800,height = 800,res=150)
